...
from foil_post_analysis import foil_peakarea, foil_spectrum, foil_spectrum_processed
...
#Call fx
def ta181_foil(beam_current, cooling_time, counting_time, distance_foil, irradiation_time, proton_energy, thickness_foil):
    cxfile = 'ta181cx.csv'
    foil_isotope = 'ta181'
    #tantulum constasnt
    ...
    foil_simulation(foil_isotope, df_gamma, distance_foil, energy_bins) #openmc simulation
    
    print(foil_peakarea(peakfinder_prominence, energy_bins)) #display a list of peak energy and area
...
ta181_foil(beam_current, cooling_time, counting_time, distance_foil, irradiation_time, proton_energy, thickness_foil)
