...
def foil_simulation(isotope, df_gamma, distance_foil, energy_bins):
    #Material
    #lead
    ...
    energy_filter = openmc.EnergyFilter(energy_bins[1:])
    ...
    openmc.run("Users/a.l/openmc/build/bin/openmc")